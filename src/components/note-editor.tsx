    ...
    <div className="flex flex-col h-full bg-white">
      <div className="flex items-center justify-between p-6 border-b border-blue-50">
        <Input
          ...
          className="border-none text-2xl font-extrabold p-0 focus-visible:ring-0 text-primary"
        />
        <div className="flex items-center gap-2 shrink-0">
          <Button variant="ghost" size="icon" onClick={onDelete} className="text-muted-foreground hover:text-red-500 transition-colors">
      ...
      <div className="flex-1 p-8 flex flex-col gap-4 overflow-hidden bg-blue-50/20">
        <Textarea
          value={content}
      ...
      <div className="p-6 border-t border-blue-50 bg-white flex justify-between items-center">
        ...
        <Button 
          ...
          className="rounded-full bg-blue-50 text-primary hover:bg-blue-100"
        >
